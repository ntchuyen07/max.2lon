...
.pedastal-block1::before, .pedastal-block1::before {
  content: '';
  position: absolute;
  right: 0;
}
...
.pedastal-block2::before, .pedastal-block2::before {
  content: '';
  position: absolute;
  right: 0;
}
...
.upper-support .ornaments div:first-child::after, .upper-support .ornaments div:last-child::after {
  display: none;
}
.upper-support .ornaments div:first-child::before, .upper-support .ornaments div:last-child::before {
  width: 6px;
  height: 6px;
}
...
.roof-top div, .roof-top div:first-child::before, .roof-top div:first-child::after, .roof-top div:last-child::before, .roof-top div:last-child::after {
  width: 8px;
  height: 8px;
  background: #FDBB3B;
  position: absolute;
...
<body>
  ...
  <div class="headline">
    ...
    <a style="text-decoration: none;" href="{{URL::to('/home')}}"><h2>Back to home</h2></a>
  </div>
